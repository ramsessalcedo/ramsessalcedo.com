  ...
  <section className="py-64 px-8 text-center bg-black relative">
    <div className="max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
        <h2 className="text-[clamp(3rem,10vw,8rem)] font-black text-white tracking-tighter mb-16 italic">Ready to predict?</h2>
        <a href="mailto:jobs@ramsessalcedo.com" className="bg-white text-black px-12 py-8 rounded-full font-black text-lg tracking-[0.3em] uppercase hover:bg-emerald-500 transition-all">
...
export default function HiringPage() {
  return (
    <div className="min-h-screen bg-black text-zinc-100 selection:bg-emerald-500 selection:text-black antialiased">
      <Navbar />
      <main>
        <Hero />
        <BentoPrerequisites />
